...
<section id="content" class="service">
	<div class="content-wrap" style="transform: none;padding-top:20px; background:url('images/carousel/4.jpg'); background-size:cover;	min-height:700px;">
	...
	<h2>  <?php echo Services4;?> </h2>
	<p>	<?php echo Services4_t_long1;?></p>
	<p><?php echo Services4_t_long2;?></p>
