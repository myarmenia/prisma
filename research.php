...
<section id="content" class="service">
	<div class="content-wrap" style="transform: none;padding-top:20px; background:url('images/carousel/2.jpg'); background-size:cover;	min-height:700px;">
	...
	<h2> <?php echo Services2;?> </h2>
	<p><?php echo Services2_t_long;?>
</p>
