...
<section id="content" class="service">
	<div class="content-wrap" style="transform: none;padding-top:20px; background:url('images/carousel/1.jpg'); background-size:cover;	min-height:700px;">
	...
	<h2>  <?php echo Services1;?> </h2>
	<p><?php echo Services1_t_long1;?> </p>
<p><?php echo Services1_t_long2;?></p>
<p><?php echo Services1_t_long3;?></p>
