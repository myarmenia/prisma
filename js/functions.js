...
$.fn.inlineStyle = function (e) {
    ...
    for (var e = 0, t = ["ms", "moz", "webkit", "o"],
             a = 0; a < t.length && !window.requestAnimationFrame; ++a)window.requestAnimationFrame = window[t[a] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[t[a] + "CancelAnimationFrame"] || window[t[a] + "CancelRequestAnimationFrame"];
    window.requestAnimationFrame || (window.requestAnimationFrame = function (t, a) {
        var i = (new Date).getTime(), s = Math.max(0, 16 - (i - e)), o = window.setTimeout(function () {
            t(i + s)
        }, s);
        return e = i + s, o
...
!function ($) {
    ...
    SEMICOLON.initialize = {
        init: function () {
            ...
            jRespond([{label: "smallest", enter: 0, exit: 575}, {
                label: "handheld",
                enter: 576,
                exit: 767
            ...
            $verticalMiddleEl.length > 0 && $verticalMiddleEl.each(function () {
                var e = $(this), t = e.outerHeight(), a = $header.outerHeight();
            ...
            var e = $goToTopEl.attr("data-speed"), t = $goToTopEl.attr("data-easing");
            ...
            var e = $goToTopEl.attr("data-mobile"), t = $goToTopEl.attr("data-offset");
            ...
            $fullScreenEl.length > 0 && $fullScreenEl.each(function () {
                var e = $(this), t = window.innerHeight ? window.innerHeight : $window.height(),
            ...
            if ($testimonialsGridEl.length > 0)if ($body.hasClass("device-md") || $body.hasClass("device-lg") || $body.hasClass("device-xl")) {
                var e = 0;
            ...
            var e = $('[data-lightbox="image"]'), t = $('[data-lightbox="gallery"]'), a = $('[data-lightbox="iframe"]'),
                i = $('[data-lightbox="inline"]'), s = $('[data-lightbox="ajax"]'),
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-target"), a = t.split("#")[1], i = e.attr("data-delay"),
                    s = e.attr("data-timeout"), o = e.attr("data-animate-in"), n = e.attr("data-animate-out");
            ...
            $(".image_fade").hover(function () {
                $(this).filter(":not(:animated)").animate({opacity: .8}, 400)
            }, function () {
            ...
            var e = $body.attr("data-animation-in"), t = $body.attr("data-animation-out"),
                a = $body.attr("data-speed-in"), i = $body.attr("data-speed-out"), s = !1,
                o = $body.attr("data-loader-timeout"), n = $body.attr("data-loader"),
                r = $body.attr("data-loader-color"), l = $body.attr("data-loader-html"), d = "", c = "", u = "", f = "",
                h = "", p = "";
            e || (e = "fadeIn"),
			t || (t = "fadeOut"), 
			a || (a = 1500), 
...
$wrapper.animsition({
				...
				//loadingInner: l + '<a href="?transition=disable" class="button button-small button-rounded disable-pagetransition"> -------- </a>',,
                loadingInner: l + '<a href="?transition=disable" class=" disable-pagetransition"></a>',
                timeout: s,
                timeoutCountdown: o,
                onLoadEvent: !0,
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-lazyload");
                e.attr("src", "images/blank.svg").css({background: "url(images/preloader.gif) no-repeat center center #FFF"}), e.appear(function () {
            ...
            var t = 4, a = e.attr("data-xl-col"), i = e.attr("data-lg-col"), s = e.attr("data-md-col"),
                o = e.attr("data-sm-col"), n = e.attr("data-xs-col");
            ...
            if (e.css({width: ""}), e.hasClass("portfolio-full")) {
                var t = SEMICOLON.initialize.defineColumns(e), a = e.width(), i = Math.floor(a / t);
                if ($body.hasClass("device-xs"))var s = 1; else s = 0;
                e.find(".portfolio-item").each(function (e) {
                    if (0 == s && $(this).hasClass("wide"))var t = 2 * i; else t = i;
                    $(this).css({width: t + "px"})
                })
            ...
            var e = $("[data-class-xs]"), t = $("[data-class-sm]"), a = $("[data-class-md]"), i = $("[data-class-lg]"),
                s = $("[data-class-xl]");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-class-xs"),
                ...
                var e = $(this), t = e.attr("data-class-sm"),
                ...
                var e = $(this), t = e.attr("data-class-md"),
                ...
                var e = $(this), t = e.attr("data-class-lg"),
                ...
                var e = $(this), t = e.attr("data-class-xl"),
            ...
            var e = $("[data-height-xs]"), t = $("[data-height-sm]"), a = $("[data-height-md]"),
                i = $("[data-height-lg]"), s = $("[data-height-xl]");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-height-xs");
                $body.hasClass("device-xs") && "" != t && e.css("height", t)
            }), t.length > 0 && t.each(function () {
                var e = $(this), t = e.attr("data-height-sm");
                $body.hasClass("device-sm") && "" != t && e.css("height", t)
            }), a.length > 0 && a.each(function () {
                var e = $(this), t = e.attr("data-height-md");
                $body.hasClass("device-md") && "" != t && e.css("height", t)
            }), i.length > 0 && i.each(function () {
                var e = $(this), t = e.attr("data-height-lg");
                $body.hasClass("device-lg") && "" != t && e.css("height", t)
            }), s.length > 0 && s.each(function () {
                var e = $(this), t = e.attr("data-height-xl");
        ...
        init: function () {
            ...
            $("#primary-menu .mega-menu-content, #primary-menu ul ul").each(function (e, t) {
                var a = $(t), i = a.offset(), s = a.width(), o = i.left;
            ...
            }), $("#primary-menu.sub-title").children("ul").children(".current").prev().css({backgroundImage: "none"})), ($("#primary-menu").hasClass("on-click") || $body.hasClass("device-md") || $body.hasClass("device-sm") || $body.hasClass("device-xs")) && $("#primary-menu li:has(ul) > a").on("click touchend", function (e) {
            ...
            if ($body.hasClass("overlay-menu")) {
                var e = $("#primary-menu").children("ul").children("li"), t = e.outerHeight(), a = e.length * t,
                    i = ($window.height() - a) / 2;
                $("#primary-menu").children("ul").children("li:first-child").css({"margin-top": i + "px"})
            }
            ...
            if ($onePageMenuEl.length > 0) {
                var e = $onePageMenuEl.attr("data-speed"), t = $onePageMenuEl.attr("data-offset"),
                    a = $onePageMenuEl.attr("data-easing");
                e || (e = 1e3), a || (a = "easeOutQuad"), $onePageMenuEl.find("a[data-href]").off("click").on("click", function () {
                    var i = $(this), s = i.attr("data-href"), o = i.attr("data-speed"), n = i.attr("data-offset"),
                        r = i.attr("data-easing");
                    if ($(s).length > 0) {
                        if (t) l = t; else var l = SEMICOLON.initialize.topScrollOffset();
            ...
            var e = "home", t = $headerWrap.outerHeight();
            return $body.hasClass("side-header") && (t = 0), $pageSectionEl.each(function (a) {
                var i = $(this).offset().top, s = $window.scrollTop();
            ...
            if (stickyMenuClasses)var e = stickyMenuClasses.split(/ +/); else e = "";
            var t = e.length;
            if (t > 0) {
                var a = 0;
            ...
            if ($body.hasClass("device-sm") || $body.hasClass("device-xs") || $body.hasClass("device-md")) {
                if (responsiveMenuClasses)var e = responsiveMenuClasses.split(/ +/); else e = "";
                var t = e.length;
                if (t > 0) {
                    var a = 0;
                    for (a = 0; a < t; a++)"not-dark" == e[a] ? ($header.removeClass("dark"), $headerWrap.addClass("not-dark")) : "dark" == e[a] ? ($headerWrap.removeClass("not-dark force-not-dark"), $header.hasClass(e[a]) || $header.addClass(e[a])) : $header.hasClass(e[a]) || $header.addClass(e[a])
            ...
            $topSocialEl.length > 0 && ($body.hasClass("device-lg") || $body.hasClass("device-xl") ? ($topSocialEl.show(), $topSocialEl.find("a").css({width: 40}), $topSocialEl.find(".ts-text").each(function () {
                var e = $(this).clone().css({
                    visibility: "hidden",
                    display: "inline-block",
                    "font-size": "13px",
                    "font-weight": "bold"
                }).appendTo($body), t = e.innerWidth() + 52;
                $(this).parent("a").attr("data-hover-width", t), e.remove()
            }), $topSocialEl.find("a").hover(function () {
                $(this).find(".ts-text").length > 0 && $(this).css({width: $(this).attr("data-hover-width")})
            }, function () {
                $(this).css({width: 40})
            })) : ($topSocialEl.show(), $topSocialEl.find("a").css({width: 40}), $topSocialEl.find("a").each(function () {
        ...
        init: function () {
            ...
            if ($body.hasClass("device-xl") || $body.hasClass("device-lg") || $body.hasClass("device-md")) {
                var e = $sliderParallaxEl.outerHeight(), t = $sliderParallaxEl.outerWidth();
            ...
            $sliderEl.each(function () {
                if ($(this).hasClass("swiper_wrapper")) {
                    ...
                    var element = $(this).filter(".swiper_wrapper"), elementDirection = element.attr("data-direction"),
                    ...
                    if (elementSpeed || (elementSpeed = 300), elementDirection || (elementDirection = "horizontal"), elementAutoPlay = elementAutoPlay ? Number(elementAutoPlay) : 999999999, elementLoop = "true" == elementLoop, elementEffect || (elementEffect = "slide"), elementGrabCursor = "false" != elementGrabCursor, sliderVideoAutoPlay = "false" != sliderVideoAutoPlay, element.find(".swiper-pagination").length > 0)var elementPagination = element.find(".swiper-pagination"),
                        elementPaginationClickable = !0; else var elementPagination = "",
                            ...
                            on: {
                                init: function (e) {
                                    SEMICOLON.slider.sliderParallaxDimensions(), element.find(".yt-bg-player").attr("data-autoplay", "false").removeClass("customjs"), SEMICOLON.widget.youtubeBgVideo(), $(".swiper-slide-active [data-animate]").each(function () {
                                        var e = $(this), t = e.attr("data-delay"), a = 0;
                                        ...
                                        var e = $(this), t = e.attr("data-animate");
            ...
            var e = SEMICOLON.slider.sliderParallaxOffset(), t = $sliderParallaxEl.outerHeight();
            if (!$body.hasClass("device-xl") && !$body.hasClass("device-lg") || SEMICOLON.isMobile.any()) $sliderParallaxEl.find(".slider-parallax-inner").length > 0 ? $(".slider-parallax-inner,.slider-parallax .slider-caption,.ei-title").css({transform: "translateY(0px)"}) : $(".slider-parallax,.slider-parallax .slider-caption,.ei-title").css({transform: "translateY(0px)"}); else {
                if (t + e + 50 > $window.scrollTop())if ($sliderParallaxEl.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), $window.scrollTop() > e)if ($sliderParallaxEl.find(".slider-parallax-inner").length > 0) {
            ...
            if ($sliderParallaxEl.length > 0)if (!$body.hasClass("device-xl") && !$body.hasClass("device-lg") || SEMICOLON.isMobile.any()) $sliderParallaxEl.find(".slider-arrow-left,.slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({opacity: 1}); else {
                SEMICOLON.slider.sliderParallaxOffset();
                var e = $sliderParallaxEl.outerHeight();
                if ($slider.length > 0) {
                    if ($header.hasClass("transparent-header") || $("body").hasClass("side-header"))var t = 100; else t = 0;
            ...
            $sliderElement.find(".slider-caption:not(.custom-caption-pos)").each(function () {
                var e = $(this).outerHeight(), t = $sliderElement.outerHeight();
                $(this).parents("#slider").prev("#header").hasClass("transparent-header") && ($body.hasClass("device-xl") || $body.hasClass("device-lg")) ? $(this).parents("#slider").prev("#header").hasClass("floating-header") ? $(this).css({top: (t + 160 - e) / 2 + "px"}) : $(this).css({top: (t + 100 - e) / 2 + "px"}) : $(this).css({top: (t - e) / 2 + "px"})
            })
            ...
            if (e.length > 0) {
                var a = !1;
                if (e.hasClass("dark")) {
                    if (oldHeaderClasses)var i = oldHeaderClasses.split(/ +/); else i = "";
                    var s = i.length;
                    if (s > 0) {
                        var o = 0;
                        for (o = 0; o < s; o++)if ("dark" == i[o] && 1 == t) {
                            a = !0;
                            break
                        }
                    }
        ...
        init: function () {
            ...
            return $().isotope ? e.length < 1 || (!!e.hasClass("customjs") || void e.each(function () {
                    var e = $(this), t = e.attr("data-transition"), a = e.attr("data-layout"),
                        i = e.attr("data-stagger"), s = !0;
                    t || (t = "0.65s"), a || (a = "masonry"), i || (i = 0), $body.hasClass("rtl") && (s = !1), setTimeout(function () {
                        e.hasClass("portfolio") ? e.isotope({
                            ...
                            stagger: Number(i),
                            masonry: {columnWidth: e.find(".portfolio-item:not(.wide)")[0]}
            ...
            return $().isotope ? $portfolioFilter.length < 1 || (!!$portfolioFilter.hasClass("customjs") || void $portfolioFilter.each(function () {
                    var e = $(this), t = e.attr("data-container"), a = e.attr("data-active-class"),
                    ...
                    }), i && (e.find("li").removeClass(a), e.find('[data-filter="' + i + '"]').parent("li").addClass(a), $(t).isotope({filter: i}))
            ...
            e.length > 0 && e.each(function () {
                ...
                if (e.find(".portfolio-desc").length > 0) {
                    var t = e.outerHeight(), a = e.find(".portfolio-desc").outerHeight();
                    if (e.find("a.left-icon").length > 0 || e.find("a.right-icon").length > 0 || e.find("a.center-icon").length > 0)var i = 60; else i = 0;
                    var s = (t - a - i) / 2;
            ...
            var t = SEMICOLON.portfolio.getNextItem(e), a = SEMICOLON.portfolio.getPrevItem(e);
            $("#next-portfolio").attr("data-id", t), $("#prev-portfolio").attr("data-id", a)
        }, loadItem: function (e, t, a) {
            a || (a = !1);
            var i = SEMICOLON.portfolio.getNextItem(e), s = SEMICOLON.portfolio.getPrevItem(e);
            if (0 == a) {
            ...
            var e = $portfolioDetails.find("img").length, t = 0;
            if (e > 0) $portfolioDetails.find("img").on("load", function () {
                ...
                if (e === t) {
                    ...
                    setTimeout(function () {
                        SEMICOLON.widget.loadFlexSlider(), SEMICOLON.initialize.lightbox(), SEMICOLON.initialize.resizeVideos(), SEMICOLON.widget.masonryThumbs(), $("html,body").stop(!0).animate({scrollTop: $portfolioDetails.offset().top - a}, 900, "easeOutQuad")
                    }, 500)
                }
            }); else {
                var a = SEMICOLON.initialize.topScrollOffset();
        ...
        init: function () {
            ...
            ($parallaxEl.length > 0 || $parallaxPageTitleEl.length > 0 || $parallaxPortfolioEl.length > 0) && (SEMICOLON.isMobile.any() ? ($parallaxEl.addClass("mobile-parallax"), $parallaxPageTitleEl.addClass("mobile-parallax"), $parallaxPortfolioEl.addClass("mobile-parallax")) : skrollr.init({forceHeight: !1}))
        }, animations: function () {
            ...
            e.length > 0 && ($body.hasClass("device-xl") || $body.hasClass("device-lg") || $body.hasClass("device-md")) && e.each(function () {
                var e = $(this), t = e.attr("data-animate-out"), a = e.attr("data-delay"), i = e.attr("data-delay-out"),
                    s = 0, o = 3e3;
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.parent(".fslider").attr("data-animation"),
                    a = e.parent(".fslider").attr("data-easing"), i = e.parent(".fslider").attr("data-direction"),
                    s = e.parent(".fslider").attr("data-reverse"), o = e.parent(".fslider").attr("data-slideshow"),
                    n = e.parent(".fslider").attr("data-pause"), r = e.parent(".fslider").attr("data-speed"),
                    l = e.parent(".fslider").attr("data-video"), d = e.parent(".fslider").attr("data-pagi"),
                    c = e.parent(".fslider").attr("data-arrows"), u = e.parent(".fslider").attr("data-thumbs"),
                    f = e.parent(".fslider").attr("data-hover"), h = e.parent(".fslider").attr("data-smooth-height"),
                    p = e.parent(".fslider").attr("data-touch"), m = !1;
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.find("video"), a = e.outerWidth(), i = e.outerHeight(), s = 16 * i / 9, o = i;
                if (s < a && (s = a, o = 9 * a / 16), t.css({width: s + "px", height: o + "px"}), o > i && t.css({
                        left: "",
                        top: -(o - i) / 2 + "px"
                    }), s > a && t.css({
                        top: "",
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-video"), a = e.attr("data-mute"), i = e.attr("data-ratio"),
                    s = e.attr("data-quality"), o = e.attr("data-opacity"), n = e.attr("data-container"),
                    r = e.attr("data-optimize"), l = e.attr("data-loop"), d = e.attr("data-volume"),
                    c = e.attr("data-start"), u = e.attr("data-stop"), f = e.attr("data-autoplay"),
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-speed"), a = e.attr("data-active");
                t || (t = 400), a ? a -= 1 : a = 0;
                var i = window.location.hash;
                if (jQuery(i).length > 0) {
                    var s = i.split("#"), o = document.getElementById(s[1]);
                    a = jQuery(".tab-content").index(o)
                }
                e.tabs({active: Number(a), show: {effect: "fade", duration: Number(t)}})
            })
        }, tabsJustify: function () {
            if ($("body").hasClass("device-xs") || $("body").hasClass("device-sm")) $(".tabs.tabs-justify").find(".tab-nav > li").css({width: ""}); else {
                var e = $(".tabs.tabs-justify");
                e.length > 0 && e.each(function () {
                    var e, t = $(this), a = t.find(".tab-nav > li"), i = a.length, s = 0;
                    s = t.hasClass("tabs-bordered") || t.hasClass("tabs-bb") ? t.find(".tab-nav").outerWidth() : t.find("tab-nav").hasClass("tab-nav2") ? t.find(".tab-nav").outerWidth() - 10 * i : t.find(".tab-nav").outerWidth() - 30, e = Math.floor(s / i), a.css({width: e + "px"})
                })
            }
            ...
            e.each(function () {
                var e = $(this), t = e.find(".tab-nav"), a = e.find(".tab-container");
                t.children("li").each(function () {
                    var e = $(this).children("a"), t = e.attr("href"), i = e.html();
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e = $(this), t = e.tabs("option", "active") + 1, a = e.attr("data-accordion-style");
            ...
            var e = $(".accordion");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-state"), a = e.attr("data-active");
                a ? a -= 1 : a = 0, e.find(".acc_content").hide(), "closed" != t && e.find(".acctitle:eq(" + Number(a) + ")").addClass("acctitlec").next().show(), e.find(".acctitle").off("click").on("click", function () {
                    if ($(this).next().is(":hidden")) {
                        ...
                        $(this).toggleClass("acctitlec").next().stop().slideDown("normal", function () {
                            ($body.hasClass("device-sm") || $body.hasClass("device-xs")) && e.hasClass("scroll-on-open") && $("html,body").stop(!0).animate({scrollTop: t.offset().top - (SEMICOLON.initialize.topScrollOffset() - 40)}, 800, "easeOutQuad")
                        })
                    }
                    return !1
                })
            ...
            e.length > 0 && e.each(function () {
                var e = $(this), t = $(this).find("span").attr("data-comma");
                t = !!t, $body.hasClass("device-xl") || $body.hasClass("device-lg") ? e.appear(function () {
                    SEMICOLON.widget.runCounter(e, t)
                }, {accX: 0, accY: -120}, "easeInCubic") : SEMICOLON.widget.runCounter(e, t)
            })
            ...
            var e = $(".rounded-skill");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-size"), a = e.attr("data-speed"), i = e.attr("data-width"),
                    s = e.attr("data-color"), o = e.attr("data-trackcolor");
                ...
                $body.hasClass("device-xl") || $body.hasClass("device-lg") ? (e.css({
                    ...
                    height: t + "px",
                    "line-height": t + "px"
                }).animate({opacity: 0}, 10), e.appear(function () {
                ...
                }, {accX: 0, accY: -120}, "easeInCubic")) : SEMICOLON.widget.runRoundedSkills(e, n)
            })
            ...
            var e = $(".progress");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.parent("li"), a = t.attr("data-percent");
                $body.hasClass("device-xl") || $body.hasClass("device-lg") ? e.appear(function () {
                    t.hasClass("skills-animated") || (e.find(".counter-instant span").countTo(), t.find(".progress").css({width: a + "%"}).addClass("skills-animated"))
                }, {
                    accX: 0,
                    accY: -120
                }, "easeInCubic") : (e.find(".counter-instant span").countTo(), t.find(".progress").css({width: a + "%"}))
            })
            ...
            var e = $(".twitter-feed");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-username"), a = e.attr("data-count"), i = e.attr("data-loader");
            ...
            var e = $(".flickr-feed");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-id"), a = e.attr("data-count"), i = "photos_public.gne";
            ...
            a.length > 0 && a.each(function () {
                var a = $(this), i = a.attr("id"), s = a.attr("data-user"), o = a.attr("data-tag"),
                    n = (a.attr("data-location"), a.attr("data-count")), r = a.attr("data-type"),
                    l = a.attr("data-sortBy"), d = a.attr("data-resolution");
            ...
            t.length > 0 && ($.jribbble.setToken(e), t.each(function () {
                var e = $(this), t = e.attr("data-user"), a = e.attr("data-count"), i = e.attr("data-list"),
                    s = e.attr("data-type");
            ...
            var e = $(".nav-tree");
            e.length > 0 && e.each(function () {
                var e = $(this), t = e.attr("data-speed"), a = e.attr("data-easing");
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e = $(this), t = e.attr("data-items"), a = e.attr("data-items-xl"), i = e.attr("data-items-lg"),
                    s = e.attr("data-items-md"), o = e.attr("data-items-sm"), n = e.attr("data-items-xs"),
                    r = e.attr("data-loop"), l = e.attr("data-autoplay"), d = e.attr("data-speed"),
                    c = e.attr("data-animate-in"), u = e.attr("data-animate-out"), f = e.attr("data-nav"),
                    h = e.attr("data-pagi"), p = e.attr("data-margin"), m = e.attr("data-stage-padding"),
                    g = e.attr("data-merge"), v = e.attr("data-start"), C = e.attr("data-rewind"),
                    b = e.attr("data-slideby"), y = e.attr("data-center"), O = e.attr("data-lazyload"),
                    w = e.attr("data-video"), S = e.attr("data-rtl"), x = 5e3, E = !0;
            ...
            toastr.remove();
            var t = $(e), a = t.attr("data-notify-position"), i = t.attr("data-notify-type"),
                s = t.attr("data-notify-msg"), o = t.attr("data-notify-timeout"), n = t.attr("data-notify-close");
            ...
            $textRotaterEl.length > 0 && $textRotaterEl.each(function () {
                $(this);
                var e = $(this).attr("data-rotate"), t = $(this).attr("data-speed"), a = $(this).attr("data-separator");
                e || (e = "fade"), t || (t = 1200), a || (a = ",");
                $(this).find(".t-rotate").Morphext({animation: e, separator: a, speed: Number(t)})
            })
        }, linkScroll: function () {
            $("a[data-scrollto]").off("click").on("click", function () {
                var e = $(this), t = e.attr("data-scrollto"), a = e.attr("data-speed"), i = e.attr("data-offset"),
                    s = e.attr("data-easing"), o = e.attr("data-highlight");
                return !!e.parents("#primary-menu").hasClass("on-click") || (a || (a = 750), i || (i = SEMICOLON.initialize.topScrollOffset()), s || (s = "easeOutQuad"), $("html,body").stop(!0).animate({scrollTop: $(t).offset().top - Number(i)}, Number(a), s, function () {
                        if (o)if ($(t).find(".highlight-me").length > 0) {
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e = $(this), t = e.find("form").attr("id"), a = e.attr("data-alert-type"),
                    i = e.attr("data-loader"), s = e.find(".form-result"), o = e.attr("data-redirect");
                a || (a = "notify"), t && $body.addClass(t + "-ready"), e.find("form").validate({
                    errorPlacement: function (e, t) {
                    ...
                    }, focusCleanup: !0, submitHandler: function (e) {
                        if (s.hide(), "button" == i) {
                            var n = $(e).find("button"), r = n.html();
                        ...
                        t && $body.removeClass(t + "-ready " + t + "-complete " + t + "-success " + t + "-error").addClass(t + "-processing"), $(e).ajaxSubmit({
                            ...
                            success: function (l) {
                                ...
                                if ("inline" == a) {
                                    if ("error" == l.alert)var d = "alert-danger"; else d = "alert-success";
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e = $(this), t = e.attr("data-alert-type"), a = e.attr("data-loader"),
                    i = e.find(".widget-subscribe-form-result"), s = e.attr("data-redirect");
                e.find("form").validate({
                    submitHandler: function (e) {
                        if (i.hide(), "button" == a) {
                            var o = $(e).find("button"), n = o.html();
                        ...
                        $(e).ajaxSubmit({
                            target: i, dataType: "json", resetForm: !0, success: function (r) {
                                ...
                                if ("inline" == t) {
                                    if ("error" == r.alert)var l = "alert-danger"; else l = "alert-success";
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e, t, a = $(this), i = a.find(".scw-ticker-item"), s = i.length, o = a.attr("data-speed"),
                    n = a.attr("data-hover"), r = a.attr("data-items"), l = a.attr("data-items-xl"),
                    d = a.attr("data-items-lg"), c = a.attr("data-items-md"), u = a.attr("data-items-sm"),
                ...
                i.css({width: e}), setTimeout(function () {
                    h.css({width: t}), a.css({width: 2 * t}), i.clone().appendTo(a.find(".scw-ticker-wrap-clone"))
                }, 300), o || (o = 3e4), n = "false" != n;
                var p = t / windowWidth;
                h.css({"animation-duration": Number(o) * p + "ms"}), 1 == n && (a.on("mouseover", function () {
            ...
            if (e.length < 1)return !0;
            e.each(function () {
                var e = $(this), t = e.attr("data-offset-top"), a = e.attr("data-offset-bottom");
            ...
            if ($cookieNotification.length > 0) {
                ...
                $cookieNotification.css({bottom: -e}), "yesConfirmed" != Cookies.get("websiteUsesCookies") && $cookieNotification.css({
                    bottom: 0,
                    opacity: 1
                    ...
                    return $cookieNotification.css({
                        bottom: -e,
                        opacity: 0
                    }), Cookies.set("websiteUsesCookies", "yesConfirmed", {expires: 30}), !1
                })
            }
            ...
            $().tooltip ? $('[data-toggle="tooltip"]').tooltip({container: "body"}) : console.log("extras: Bootstrap Tooltip not defined."), $().popover ? $("[data-toggle=popover]").popover() : console.log("extras: Bootstrap Popover not defined."), $(".style-msg").on("click", ".close", function (e) {
                $(this).parents(".style-msg").slideUp(), e.preventDefault()
            }), $("#primary-menu-trigger,#overlay-menu-close, .menu_cl").off("click").on("click", function () {
        ...
        init: function () {
            ...
            SEMICOLON.header.stickyMenu(t), SEMICOLON.header.stickyPageMenu(a), $window.on("scroll", function () {
				...
				if($(document).scrollTop() > 100 &&  $(window).width()>991 ){
					$('#header-wrap').css({"transition":"all 0.8s ease-in","top":"35px"})
				}
				else{
					if($(window).width()>991){
					$('#header-wrap').css({"transition":"all 0.8s  ease-out","top":"168px"})}
					else{
						$('#header-wrap').css({"transition":"all 0.8s  ease-out","top":"0"})
					}
				}
    ...
    var $window = $(window), $body = $("body"), $wrapper = $("#wrapper"), $header = $("#header"),
        ...
        $sliderElement = $(".slider-element"), swiperSlider = "", $pageTitle = $("#page-title"),
        ...
        $goToTopEl = $("#gotoTop"), $fullScreenEl = $(".full-screen"), $testimonialsGridEl = $(".testimonials-grid"),
        $pageSectionEl = $(".page-section"), $owlCarouselEl = $(".owl-carousel"), $parallaxEl = $(".parallax"),
        $parallaxPageTitleEl = $(".page-title-parallax"),
        $parallaxPortfolioEl = $(".portfolio-parallax").find(".portfolio-image"), $textRotaterEl = $(".text-rotater"),
...
}(jQuery), function (e, t, a, i, s, n, o) {
    e.GoogleAnalyticsObject = s, e.ga = e.ga || function () {
            (e.ga.q = e.ga.q || []).push(arguments)
        }, e.ga.l = 1 * new Date  
		/* ,n = t.createElement("script"), 
		o = t.getElementsByTagName("script")[0], 
		n.async = 1, n.src = "//www.google-analytics.com/analytics.js",
...
jQuery(document).one("ajaxComplete", function () {
    jQuery(".preloader-demo").on("click", function (s) {
        var i = jQuery(this), d = jQuery(".preloader-demo"), v = i.attr("data-loader");
